  ...
  return (
    <>
      ...
      <main className="bg-gray-50 pt-25 pb-15 min-h-[calc(100vh-4rem)]">
        ...
        <h1 className="text-center font-inter text-2xl mt-2" data-aos="zoom-in">Transforming Email Marketing</h1>
        <p className="text-sm text-center mt-1 mx-auto text-accent w-[80%]" data-aos="zoom-in">The future of email marketing is here</p>
        <div className="mt-6">
