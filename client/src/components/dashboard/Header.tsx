...
const Header = () => {
  return (
    <header className="p-4 bg-white dark:bg-gray-900 dark:border-gray-800 dark:shadow-lg z-50 fixed top-0 left-0 right-0 border-b-1 border-b-accentLight flex-between">
