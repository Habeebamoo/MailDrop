    ...
    <section className="pt-[100px] pb-5 bg-bg px-2 ">
      <div className="lg:grid lg:grid-cols-2 lg:gap-2 lg:w-[80%] mx-auto">
        <div className="lg:mt-10 max-lg:px-4">
          ...
          <h1 data-aos="zoom-in" className="font-inter text-primary text-4xl mt-6">Email Marketing Made Simple & Secure</h1>
        ...
        <div className="max-sm:my-22 lg:ml-5">
          <div className="flex-center" data-aos="zoom-in">
            <img src={heroImg} className="max-lg:h-[270px] lg:h-[250px]" />
          </div>
        </div>
      </div>
    </section>
